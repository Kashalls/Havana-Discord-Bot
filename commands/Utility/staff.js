    ...
    execute: async (bot, msg, args, commands, logger, c, s) => {
        ...
        msg.channel.createMessage({
            embed: {
                ...
                fields: [{
                        name: "<:online:409660331401412608> Online",
                        value: staffOnline.join(", ")
                    },
                    {
                        name: "<:DND:409660329736404992> DND",
                        value: staffDnd.join(", ")
                    },
                    {
                        name: "<:away:409660329702719488> Idle",
                        value: staffAway.join(", ")
                    },
                    {
                        name: "<:Offline:409660331267457025> Offline",
                        value: staffOffline.join(", ")
                    },
                ]
            }
        })
